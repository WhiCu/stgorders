...
-- delivery.order_id -> orders.order_uid
insert into delivery (order_id, name, phone, zip, city, address, region, email) values
('order_001', 'John Doe',     '+123456789',  '12345',  'New York', '123 Main St',     'NY',                  'john@example.com'),
('order_002', 'Иван Иванов',  '+79991234567','101000', 'Москва',   'ул. Ленина, 5',   'Московская область', 'ivan@example.com');

-- payment.transaction -> orders.order_uid
insert into payment (
...
-- items.track_number -> orders.track_number
insert into items (
